...
--
-- Die Migration 00224 steht in der Migrations-History der Remote-Datenbank
...
-- 00224 gilt remote laengst als ausgefuehrt und wird uebersprungen.
--
-- ACHTUNG beim Wiederherstellen auf einer frischen Datenbank (siehe BACKUP.md):
-- was auch immer 00224 getan hat, fehlt dort. Der Weg dahin ist ein Dump der
