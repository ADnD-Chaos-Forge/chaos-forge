...
exports.UNDEAD_LABELS = exports.UNDEAD_TYPES = void 0;
exports.getTurnTarget = getTurnTarget;
exports.resolveTurnAttempt = resolveTurnAttempt;
exports.getPaladinTurnLevel = getPaladinTurnLevel;
...
function levelToColumnIndex(level) {
    if (level <= 0)
        return -1; // can't turn
    if (level <= 9)
        return level - 1; // L1=0, L2=1, ... L9=8
    if (level <= 11)
        return 9; // L10-11
    if (level <= 13)
        return 10; // L12-13
 ...
 */
function getTurnTarget(undeadType, clericLevel) {
 ...
 */
function resolveTurnAttempt(clericLevel, undeadType, d20Roll, affectedHDRoll, isEvil, extraRoll = 0) {
 ...
 */
function getPaladinTurnLevel(paladinLevel) {
