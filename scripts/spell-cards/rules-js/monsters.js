...
exports.parseHitDice = parseHitDice;
exports.rollMonsterHp = rollMonsterHp;
exports.parseDamageString = parseDamageString;
exports.parseAttacksPerRound = parseAttacksPerRound;
/**
 * Parse a Monstrous Manual hit dice expression.
 * Examples: "4", "4+1", "3-1", "1/2", "12+3"
 */
function parseHitDice(hd) {
 ...
 */
function rollMonsterHp(parsed, rng = Math.random) {
    if (parsed.dice === 0) {
...
function parseSingleDamage(dmg) {
 ...
 */
function parseAttacksPerRound(apr) {
