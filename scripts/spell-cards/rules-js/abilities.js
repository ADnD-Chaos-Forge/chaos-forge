...
exports.getStrengthModifiers = getStrengthModifiers;
exports.getDexterityModifiers = getDexterityModifiers;
exports.getConstitutionModifiers = getConstitutionModifiers;
exports.getIntelligenceModifiers = getIntelligenceModifiers;
exports.getWisdomModifiers = getWisdomModifiers;
exports.getCharismaModifiers = getCharismaModifiers;
exports.rollAbilityScoresMethodI = rollAbilityScoresMethodI;
exports.rollAbilityScoresMethodII = rollAbilityScoresMethodII;
exports.rollAbilityScoresMethodIII = rollAbilityScoresMethodIII;
exports.rollAbilityScoresMethodIV = rollAbilityScoresMethodIV;
exports.rollAbilityScoresMethodV = rollAbilityScoresMethodV;
exports.getAllAbilityModifiers = getAllAbilityModifiers;
exports.getTotalLanguageSlots = getTotalLanguageSlots;
...
function lookupStrength(str, exceptional) {
 ...
 */
function getStrengthModifiers(str, exceptional, muscle, stamina) {
 ...
 */
function getDexterityModifiers(dex, aim, balance) {
 ...
 */
function getConstitutionModifiers(con, health, fitness) {
 ...
 */
function getIntelligenceModifiers(int, knowledge, reason) {
...
const WIS_TABLE = [
    ...
    // WIS 20
    {
        ...
        bonusSpells: [3, 2, 2, 1],
        spellFailure: 0,
        spellImmunity: "Cause Fear, Charm Person, Command, Friends, Hypnotism, Forget, Hold Person, Ray of Enfeeblement, Scare",
    },
    // WIS 21
    {
        magicalDefenseAdj: 4,
        ...
        spellFailure: 0,
        spellImmunity: "Cause Fear, Charm Person, Command, Friends, Hypnotism, Forget, Hold Person, Ray of Enfeeblement, Scare, Fear",
    },
    // WIS 22
    {
        magicalDefenseAdj: 4,
        ...
        spellFailure: 0,
        spellImmunity: "Cause Fear, Charm Person, Command, Friends, Hypnotism, Forget, Hold Person, Ray of Enfeeblement, Scare, Fear, Charm Monster, Confusion, Emotion, Fumble, Suggestion",
    },
    // WIS 23
    {
        magicalDefenseAdj: 4,
        ...
        spellFailure: 0,
        spellImmunity: "Cause Fear, Charm Person, Command, Friends, Hypnotism, Forget, Hold Person, Ray of Enfeeblement, Scare, Fear, Charm Monster, Confusion, Emotion, Fumble, Suggestion, Chaos, Feeblemind, Hold Monster, Magic Jar, Quest",
    },
    // WIS 24
    {
        magicalDefenseAdj: 4,
        ...
        spellFailure: 0,
        spellImmunity: "Cause Fear, Charm Person, Command, Friends, Hypnotism, Forget, Hold Person, Ray of Enfeeblement, Scare, Fear, Charm Monster, Confusion, Emotion, Fumble, Suggestion, Chaos, Feeblemind, Hold Monster, Magic Jar, Quest, Geas, Mass Suggestion, Rod of Rulership",
    },
    // WIS 25
    {
        magicalDefenseAdj: 4,
        ...
        spellFailure: 0,
        spellImmunity: "Cause Fear, Charm Person, Command, Friends, Hypnotism, Forget, Hold Person, Ray of Enfeeblement, Scare, Fear, Charm Monster, Confusion, Emotion, Fumble, Suggestion, Chaos, Feeblemind, Hold Monster, Magic Jar, Quest, Geas, Mass Suggestion, Rod of Rulership, Antipathy/Sympathy, Death Spell, Mass Charm",
    },
];
/**
 ...
 */
function getWisdomModifiers(wis, intuition, willpower) {
 ...
 */
function getCharismaModifiers(cha, leadership, appearance) {
 ...
 */
function getAllAbilityModifiers(character) {
    return {
        strMods: getStrengthModifiers(character.str, character.str_exceptional ?? undefined, character.str_muscle, character.str_stamina),
        ...
        chaMods: getCharismaModifiers(character.cha, character.cha_leadership, character.cha_appearance),
    };
}
// ─── LANGUAGE SLOTS ───────────────────────────────────────────────────────────
 ...
 */
function getTotalLanguageSlots(intScore, raceId, knowledgeSub) {
