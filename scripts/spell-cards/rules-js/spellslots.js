...
exports.getBardSpellSlots = getBardSpellSlots;
exports.getWizardSpellSlots = getWizardSpellSlots;
exports.getSpecialistBonusSlots = getSpecialistBonusSlots;
exports.getPriestSpellSlots = getPriestSpellSlots;
exports.getPriestBonusSlots = getPriestBonusSlots;
exports.getPriestSpellPoints = getPriestSpellPoints;
exports.getPriestBonusSpellPoints = getPriestBonusSpellPoints;
exports.getPriestSpellCost = getPriestSpellCost;
exports.getWizardSpellPoints = getWizardSpellPoints;
exports.getWizardSpecialistBonusPoints = getWizardSpecialistBonusPoints;
exports.getWizardBonusSpellPoints = getWizardBonusSpellPoints;
exports.getWizardSpellCost = getWizardSpellCost;
exports.getWizardMaxMemorized = getWizardMaxMemorized;
exports.canLearnSpell = canLearnSpell;
exports.getRangerSpellSlots = getRangerSpellSlots;
exports.getPaladinSpellSlots = getPaladinSpellSlots;
...
function getBardSpellSlots(level) {
 ...
 * specialist's school.
 */
function getSpecialistBonusSlots(classId, level) {
    const specialist = (0, magic_1.getSpecialist)(classId);
    if (!specialist)
        return new Array(9).fill(0);
    const baseSlots = getWizardSpellSlots(level);
    return baseSlots.map((slots) => (slots > 0 ? 1 : 0));
}
function getPriestSpellSlots(level) {
 ...
 */
function getPriestBonusSlots(wisScore) {
    const { bonusSpells } = (0, abilities_1.getWisdomModifiers)(wisScore);
...
const PRIEST_BONUS_SPELL_POINTS = {
    13: 1,
    14: 2,
    15: 4,
    16: 8,
...
const WIZARD_BONUS_SPELL_POINTS = {
    14: 1,
    15: 3,
    16: 5,
    17: 8,
...
function canLearnSpell(classId, spellSchool, spellSphere, spellLevel, intScore, priesthoodId) {
    ...
    if (cls.group === "wizard" && spellSchool) {
        ...
        const opposition = (0, magic_1.getOppositionSchools)(classId);
        ...
        const intMods = (0, abilities_1.getIntelligenceModifiers)(intScore);
    ...
    if (cls.group === "priest" && spellSphere) {
        if (!(0, magic_1.hasSphereAccess)(classId, spellSphere, "minor", priesthoodId)) {
            return { allowed: false, reason: `Kein Zugang zur Sphäre "${spellSphere}".` };
        }
        // Minor sphere access: max level 3
        if (!(0, magic_1.hasSphereAccess)(classId, spellSphere, "major", priesthoodId) && spellLevel > 3) {
            return {
                allowed: false,
...
function getRangerSpellSlots(level) {
...
function getPaladinSpellSlots(level) {
