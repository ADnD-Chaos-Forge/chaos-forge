...
exports.FIGHTING_STYLES = void 0;
exports.getAllFightingStyles = getAllFightingStyles;
exports.getAvailableFightingStyles = getAvailableFightingStyles;
exports.getSpecializableFightingStyles = getSpecializableFightingStyles;
exports.canLearnMoreFightingStyles = canLearnMoreFightingStyles;
exports.getFightingStyle = getFightingStyle;
exports.getSingleWeaponStyleBonus = getSingleWeaponStyleBonus;
exports.FIGHTING_STYLES = {
    single_weapon: {
        id: "single_weapon",
        name: "Einhandkampf",
        name_en: "Single-Weapon Style",
        description: "Kampf mit einer Einhandwaffe ohne Schild oder Zweitwaffe. Spezialisierung gewährt AC-Bonus.",
        description_en: "Fighting with a one-handed weapon and nothing in the off-hand. Specialization grants AC bonus.",
        maxSlots: 2,
        benefits: [
            {
                slots: 1,
    ...
    weapon_and_shield: {
        ...
        description: "Kampf mit Einhandwaffe und Schild. Spezialisierung ermöglicht einen Extra-Angriff mit dem Schild.",
        description_en: "Fighting with a one-handed weapon and shield. Specialization allows an extra attack with the shield.",
        maxSlots: 2,
        benefits: [
            {
                slots: 1,
    ...
    two_weapon: {
        ...
        description: "Kampf mit einer Waffe in jeder Hand. Spezialisierung reduziert Angriffsabzüge und erlaubt gleich lange Waffen.",
        description_en: "Fighting with a weapon in each hand. Specialization reduces attack penalties and allows equal-length weapons.",
        maxSlots: 1,
        benefits: [
            {
                slots: 1,
 ...
 */
function getAllFightingStyles() {
    return Object.values(exports.FIGHTING_STYLES);
}
/**
 * Get fighting styles available for a class group (known from creation).
 */
function getAvailableFightingStyles(classGroup) {
    return Object.values(exports.FIGHTING_STYLES).filter((s) => s.availableFor.includes(classGroup));
}
/**
 * Get fighting styles a class group can specialize in.
 */
function getSpecializableFightingStyles(classGroup) {
    return Object.values(exports.FIGHTING_STYLES).filter((s) => s.canSpecialize.includes(classGroup));
}
/**
 * Check if a class group can learn another fighting style specialization.
 * Warriors can learn multiple, others max 1.
 */
function canLearnMoreFightingStyles(classGroup, currentStyleCount) {
 ...
 */
function getFightingStyle(id) {
    return exports.FIGHTING_STYLES[id] ?? null;
}
/**
 ...
 */
function getSingleWeaponStyleBonus(fightingStyles) {
